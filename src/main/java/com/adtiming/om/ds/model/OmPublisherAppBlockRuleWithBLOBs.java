...
public class OmPublisherAppBlockRuleWithBLOBs extends OmPublisherAppBlockRule {
    ...
    public boolean equals(Object that) {
        ...
        OmPublisherAppBlockRuleWithBLOBs other = (OmPublisherAppBlockRuleWithBLOBs) that;
